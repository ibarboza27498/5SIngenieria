...
<nav class="navbar navbar-expand-lg navbar-light bg-gold">
    <div class="container">
        <a class="navbar-brand" href="index.jsp">
            <img src="${pageContext.request.contextPath}/assets/img/5s-logo.png" width="30" height="30" class="d-inline-block align-middle" alt="">
            Ingeniería
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ml-auto">
                <li class="nav-item active">
                    <a class="nav-link active font-weight-bold space" href="nosotros.jsp"><i class="fas fa-handshake"></i>&nbsp;&nbsp;Nosotros</a>
                </li>
                
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle font-weight-bold space active" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <li class="nav-item">
                    <a class="nav-link active font-weight-bold space" href="contactenos.jsp"><i class="fas fa-address-card"></i>&nbsp;&nbsp;Contactenos</a>
                </li>
            </ul>
        </div>
    </div>
